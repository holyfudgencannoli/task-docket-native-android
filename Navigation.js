    ...
    return(
        <RootBottomTabs.Navigator
            screenOptions={({route}) => ({
                ...
                tabBarBackground: () => (
                    <BlurView
                        tint="systemChromeMaterial" // iOS native blur
                        intensity={100}
...
function HomeNavGroup() {
    return(
            <HomeNav.Navigator>
                ...
                <HomeNav.Screen component={TaskInput} name='TaskInput' />
                <HomeNav.Screen component={RepeatingTaskInput} name='RepeatingTaskInput' />
...
function TaskNavGroup() {
    return(
        <TaskNav.Navigator>
            <TaskNav.Screen  component={RepeatingTaskRecords} name='RepeatingTaskRecords' />
            <TaskNav.Screen  component={TaskRecords} name='TaskRecords' />
            <TaskNav.Screen  component={ToDoList} name='ToDoList' />
        </TaskNav.Navigator>
    )
}
